...
def read_command(
    ...
    if content.startswith("Error"):
        ...
        console.print(Markdown(format_markdown(content)))
...
def insert_command(
    ...
    if where:
        ...
        if not potential.suffix: potential = potential.with_suffix(".md")
